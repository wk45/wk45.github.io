...
Rest of the persistent peaks are determined by the ratio to the longest bar, θ.
...
## {}
<div style="font-size: 1.2em; font-weight: bold; text-align: center; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">2D Curve Registration by Principal Component Trajectory
</div>
